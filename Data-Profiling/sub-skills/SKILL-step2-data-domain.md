...
| 业务流程全景图 | 推荐 | Markdown + mermaid | Step 1 产出 (01-业务过程识别.md) |

### 输入样例

#### 样例 A：表结构盘点表（来自Step 1 产出）

即 01-业务过程识别.md 中的表结构盘点部分，核心是这张表：
...
即 01-业务过程识别.md 中的业务流程全景图部分，包含承保板块和理赔板块的 mermaid 流程图。
